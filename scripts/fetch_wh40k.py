...
def sync_exports(
...
) -> tuple[list[str], dict[str, dict[str, str]], bool, list[str]]:
    ...
    return changed, index, bootstrap_run, skipped_missing
...
def main() -> int:
    ...
    changed, index, bootstrap_run, skipped_missing = sync_exports(
